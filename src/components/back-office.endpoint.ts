...
export const backOfficeEndPoints = {
  ...
  getTasks: `${baseUrl}tasks/get-tasks-by-Bp/`,
  createTask: `${baseUrl}tasks/add-task`,
  getServices: `${baseUrl}bp-services/bpServices`,
  getBussinessProcess: `${baseUrl}business-processes/getActiveBps `,
  getActiveBpWithServiceId: `${baseUrl}business-processes/get-Bp-By-ServiceId`,
  createServices: `${baseUrl}bp-services`,
  updateServices: `${baseUrl}bp-services/update`,
  deleteService:`${baseUrl}bp-services/deleteBpService/`,
  getServiceDetail: `${baseUrl}bp-services/bpService/`,
  deleteServices: `${baseUrl}bp-services/deleteBpService/`,
  saveWorkFlow: `${baseUrl}business-processes`,
  getSavedWorkFlow: `${baseUrl}business-processes/get-Bp-By-ServiceId/`,
};
